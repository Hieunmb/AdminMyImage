                            ...
                            <div className="col-lg-3 col-md-4">
                                <div className="card-body inbox-panel"><a href="app-compose.html" className="btn btn-danger m-b-20 p-10 w-100 waves-effect waves-light text-white">Compose</a>
                                    <ul className="list-group list-group-full">
                                        <li className="list-group-item d-flex no-block align-items-center active"> <a href="#" className="d-flex no-block align-items-center"><i className="mdi mdi-gmail fs-4 me-2 d-flex align-items-center"></i> Inbox </a><span className="badge bg-success ms-auto">6</span></li>
                                        <li className="list-group-item d-flex no-block align-items-center">
                                            <a href="#" className="d-flex no-block align-items-center"> <i className="mdi mdi-star fs-4 me-2 d-flex justify-content-center"></i> Starred </a>
                                        </li>
                                        <li className="list-group-item d-flex no-block align-items-center">
                                            <a href="#" className="d-flex  no-block align-items-center"> <i className="mdi mdi-send fs-4 me-2 d-flex align-items-center"></i> Draft </a><span className="badge bg-danger ms-auto">3</span></li>
                                        <li className="list-group-item d-flex no-block align-items-center ">
                                            <a href="#" className="d-flex no-block align-items-center"> <i className="mdi mdi-file-document-box fs-4 me-2 d-flex align-items-center"></i> Sent Mail </a>
                                        </li>
                                        <li className="list-group-item d-flex no-block align-items-center">
                                            <a href="#" className="d-flex no-block align-items-center"> <i className="fs-4 me-2 d-flex align-items-center mdi mdi-delete"></i> Trash </a>
                                        </li>
                                    </ul>
                                    <h3 className="card-title m-t-40">Labels</h3>
                                    <div className="list-group b-0 mail-list"> <a href="#" className="list-group-item"><span className="fa fa-circle text-info m-r-10"></span>Work</a> <a href="#" className="list-group-item"><span className="fa fa-circle text-warning m-r-10"></span>Family</a> <a href="#" className="list-group-item"><span className="fa fa-circle text-purple m-r-10"></span>Private</a> <a href="#" className="list-group-item"><span className="fa fa-circle text-danger m-r-10"></span>Friends</a> <a href="#" className="list-group-item"><span className="fa fa-circle text-success m-r-10"></span>Corporate</a> </div>
                                </div>
                            </div>
                                ...
                                <div className="card-body">
                                    ...
                                    <div className="btn-group m-b-10 m-r-10" role="group" aria-label="Button group with nested dropdown">
                                        <div className="btn-group" role="group">
                                            ...
                                            <div className="dropdown-menu" aria-labelledby="btnGroupDrop1"> <a className="dropdown-item" href="#">Dropdown link</a> <a className="dropdown-item" href="#">Dropdown link</a> </div>
                                        </div>
                                        <div className="btn-group" role="group">
                                    ...
                                    <div className="btn-group" role="group">
                                        ...
                                        <div className="dropdown-menu" aria-labelledby="btnGroupDrop1"> <a className="dropdown-item" href="#">Mark as all read</a> <a className="dropdown-item" href="#">Dropdown link</a> </div>
                                    </div>
                                </div>
                ...
                <div className="slimscrollright">
                    ...
                    <div className="r-panel-body">
                        <ul id="themecolors" className="m-t-20">
                            ...
                            <li><a href="#" data-skin="skin-default" className="default-theme working">1</a></li>
                            ...
                            <li><a href="#" data-skin="skin-default-dark" className="default-dark-theme ">7</a></li>
                            <li><a href="#" data-skin="skin-green-dark" className="green-dark-theme">8</a></li>
                            <li><a href="#" data-skin="skin-red-dark" className="red-dark-theme">9</a></li>
                            <li><a href="#" data-skin="skin-blue-dark" className="blue-dark-theme">10</a></li>
                            <li><a href="#" data-skin="skin-purple-dark" className="purple-dark-theme">11</a></li>
                            <li><a href="#" data-skin="skin-megna-dark" className="megna-dark-theme ">12</a></li>
                        </ul>
                        <ul className="m-t-20 chatonline">
                            <li><b>Chat option</b></li>
                            <li>
                                <a href="#"><img src="../assets/images/users/1.jpg" alt="user-img" className="img-circle"/> <span>Varun Dhavan <small className="text-success">online</small></span></a>
                            </li>
                            <li>
                                <a href="#"><img src="../assets/images/users/2.jpg" alt="user-img" className="img-circle"/> <span>Genelia Deshmukh <small className="text-warning">Away</small></span></a>
                            </li>
                            <li>
                                <a href="#"><img src="../assets/images/users/3.jpg" alt="user-img" className="img-circle"/> <span>Ritesh Deshmukh <small className="text-danger">Busy</small></span></a>
                            </li>
                            <li>
                                <a href="#"><img src="../assets/images/users/4.jpg" alt="user-img" className="img-circle"/> <span>Arijit Sinh <small className="text-muted">Offline</small></span></a>
                            </li>
                            <li>
                                <a href="#"><img src="../assets/images/users/5.jpg" alt="user-img" className="img-circle"/> <span>Govinda Star <small className="text-success">online</small></span></a>
                            </li>
                            <li>
                                <a href="#"><img src="../assets/images/users/6.jpg" alt="user-img" className="img-circle"/> <span>John Abraham<small className="text-success">online</small></span></a>
                            </li>
                            <li>
                                <a href="#"><img src="../assets/images/users/7.jpg" alt="user-img" className="img-circle"/> <span>Hritik Roshan<small className="text-success">online</small></span></a>
                            </li>
                            <li>
                                <a href="#"><img src="../assets/images/users/8.jpg" alt="user-img" className="img-circle"/> <span>Pwandeep rajan <small className="text-success">online</small></span></a>
                            </li>
                        </ul>
                    </div>
                </div>
