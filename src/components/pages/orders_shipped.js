...
function Orders_Shipped() {
    ...
    const loadOrders = async ()=>{
        try {
            const rs = await api.get(url.ORDER.GET_ORDER_SHIPPED);
            setOrders(rs.data);
        } catch (error) {
            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Orders Shipped</h4>
                    </div>
                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                        <div class="card">
                            ...
                            <div className="top_select" style={{display:"flex"}}>
                                    <h5 class="card-title">List Orders Shipped</h5>
